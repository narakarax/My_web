...
class Home extends React.Component<Props, ContactState> { 
  ...
  sendEmail = () => {
    ...
    window.open("mailto:aaronchupa610@gmail.com?subject=" + this.state.subject + "&body=" + this.state.message + "\n" + this.state.yourname);
  };
