        ...
        <main className="glory-main-wraper relative" data-spy="scroll" data-target=".navbar" data-offset="70">
          ...
          <div id='here' className='w-full h-[100vh] md:h-[700px] relative'>            
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 h-[100vh] md:h-[700px] pt-[70px] relative z-10'>              
             ...
             <iframe src="https://sketchfab.com/models/894ad84ceb8b444a91fbc05f20530bcd/embed?autospin=1&autostart=1&annotations_visible=0&ui_animations=0&ui_infos=0&ui_stop=0&ui_inspector=0&ui_watermark_link=0&ui_watermark=0&ui_hint=0&ui_ar=0&ui_help=0&ui_settings=0&ui_vr=0&ui_fullscreen=0&ui_annotations=0&ui_theme=dark&dnt=1%22className=%27absolute%20top-0%20left-0%20w-full%20h-full" className='absolute top-0 left-0 w-full h-full' />
          </div>
